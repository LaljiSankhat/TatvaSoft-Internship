...
VALUES ('Lalji', 'Sankhat', 'lalji.sankhat@tatvasoft.com', NOW(), NULL, true);
...
SELECT last_name, first_name FROM customer WHERE first_name = 'Lalji';

SELECT customer_id, first_name, last_name FROM customer WHERE first_name = 'Lalji' AND last_name = 'Sankhat';

SELECT customer_id, first_name, last_name FROM customer WHERE first_name IN ('Lalji', 'David', 'James');
...
UPDATE customer
SET first_name = 'Lalji', last_name = 'Sankhat', email = 'lalji1234@tatvasoft.com'
WHERE customer_id = 1;
